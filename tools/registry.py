...
CATEGORIES = [
    ...
    },
    {
        ...
        "tools": [
            ...
            # Batch 6
            {"slug": "ai-song-generator", "name": "AI Song Generator", "description": "Generate original song lyrics in any genre — verse, chorus, and bridge with AI.", "ai": True},
            {"slug": "ai-poem-generator", "name": "AI Poem Generator", "description": "Generate beautiful poems in any style — sonnet, haiku, free verse, and more.", "ai": True},
            {"slug": "ai-rap-generator", "name": "AI Rap Generator", "description": "Generate rap lyrics with rhyme schemes, flow, and a unique style with AI.", "ai": True},
            {"slug": "ai-answer-generator", "name": "AI Answer Generator", "description": "Get a clear, detailed answer to any question — powered by AI.", "ai": True},
            {"slug": "ai-flashcard-generator", "name": "AI Flashcard Generator", "description": "Generate study flashcards on any topic — term and definition format with AI.", "ai": True},
            {"slug": "ai-lesson-plan-generator", "name": "AI Lesson Plan Generator", "description": "Create structured, curriculum-aligned lesson plans for any subject with AI.", "ai": True},
            {"slug": "ai-script-generator", "name": "AI Script Generator", "description": "Generate video or YouTube scripts with hook, body, and CTA using AI.", "ai": True},
            {"slug": "ai-newsletter-generator", "name": "AI Newsletter Generator", "description": "Generate engaging email newsletters with intro, body sections, and CTA with AI.", "ai": True},
            {"slug": "ai-pitch-deck-generator", "name": "AI Pitch Deck Generator", "description": "Generate a complete pitch deck outline with slide content for any startup idea.", "ai": True},
            {"slug": "ai-proposal-generator", "name": "AI Proposal Generator", "description": "Generate professional project or business proposals with AI.", "ai": True},
            # Batch 7
            {"slug": "ai-python-code-generator", "name": "AI Python Code Generator", "description": "Generate Python code for any task — scripts, functions, classes, and more.", "ai": True},
            {"slug": "ai-sql-query-generator", "name": "AI SQL Query Generator", "description": "Generate SQL queries from plain English — SELECT, JOIN, aggregations, and more.", "ai": True},
            {"slug": "ai-excel-formula-generator", "name": "AI Excel Formula Generator", "description": "Generate Excel and Google Sheets formulas from plain-English descriptions.", "ai": True},
            {"slug": "ai-readme-generator", "name": "AI README Generator", "description": "Generate a professional GitHub README for any project with AI.", "ai": True},
            {"slug": "ai-image-prompt-generator", "name": "AI Image Prompt Generator", "description": "Generate detailed prompts for Midjourney, DALL-E, and Stable Diffusion.", "ai": True},
            {"slug": "ai-ad-copy-generator", "name": "AI Ad Copy Generator", "description": "Generate high-converting ad copy for Google, Meta, and LinkedIn with AI.", "ai": True},
            {"slug": "ai-question-generator", "name": "AI Question Generator", "description": "Generate questions on any topic — comprehension, discussion, or interview style.", "ai": True},
            {"slug": "ai-report-generator", "name": "AI Report Generator", "description": "Generate structured professional reports on any topic with AI.", "ai": True},
            {"slug": "ai-test-case-generator", "name": "AI Test Case Generator", "description": "Generate software test cases — unit, integration, and edge cases with AI.", "ai": True},
            {"slug": "ai-color-palette-generator", "name": "AI Color Palette Generator", "description": "Generate beautiful, on-brand color palettes with hex codes and usage guidance.", "ai": True},
        ],
    },
]
